...
public class MtsPayFrame {
     ...
     */
    public MtsPayFrame getCartNumber(){
     ...
     */
    public MtsPayFrame getFirstLastName(){
     ...
     */
    public MtsPayFrame imgPayMasterCard(){
     ...
     */
    public MtsPayFrame imgPayBelCart(){
